...
namespace turtle_spawner_component {
...
//     auto node = std::make_shared<turtle_spawner_component::TurtleController>();
...
RCLCPP_COMPONENTS_REGISTER_NODE(turtle_spawner_component::TurtleController)