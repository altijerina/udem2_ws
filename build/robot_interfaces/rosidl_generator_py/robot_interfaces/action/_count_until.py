    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robot_interfaces.action.CountUntil_Goal')
            logger.debug(
...
class CountUntil_Goal(metaclass=Metaclass_CountUntil_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.goal_number = kwargs.get('goal_number', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.goal_number != other.goal_number:
            return False
    ...
    def goal_number(self):
        """Message field 'goal_number'."""
        return self._goal_number

    @goal_number.setter
    def goal_number(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'goal_number' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'goal_number' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._goal_number = value
...
class Metaclass_CountUntil_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.CountUntil_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_CountUntil_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.CountUntil_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil_SendGoal_Request(metaclass=Metaclass_CountUntil_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'robot_interfaces/CountUntil_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_interfaces', 'action'], 'CountUntil_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_interfaces.action._count_until import CountUntil_Goal
...
class Metaclass_CountUntil_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.CountUntil_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robot_interfaces.action import _count_until
...
class CountUntil_SendGoal(metaclass=Metaclass_CountUntil_SendGoal):
    from robot_interfaces.action._count_until import CountUntil_SendGoal_Request as Request
    from robot_interfaces.action._count_until import CountUntil_SendGoal_Response as Response
...
class CountUntil_GetResult_Response(metaclass=Metaclass_CountUntil_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'robot_interfaces/CountUntil_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_interfaces', 'action'], 'CountUntil_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_interfaces.action._count_until import CountUntil_Result
...
class Metaclass_CountUntil_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.CountUntil_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil_GetResult(metaclass=Metaclass_CountUntil_GetResult):
    from robot_interfaces.action._count_until import CountUntil_GetResult_Request as Request
    from robot_interfaces.action._count_until import CountUntil_GetResult_Response as Response
...
class Metaclass_CountUntil_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.CountUntil_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil_FeedbackMessage(metaclass=Metaclass_CountUntil_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'robot_interfaces/CountUntil_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_interfaces', 'action'], 'CountUntil_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from robot_interfaces.action._count_until import CountUntil_Feedback
...
class Metaclass_CountUntil(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.CountUntil')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil(metaclass=Metaclass_CountUntil):
    ...
    from robot_interfaces.action._count_until import CountUntil_Goal as Goal
    # The result message defined in the action definition.
    from robot_interfaces.action._count_until import CountUntil_Result as Result
    # The feedback message defined in the action definition.
    from robot_interfaces.action._count_until import CountUntil_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from robot_interfaces.action._count_until import CountUntil_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from robot_interfaces.action._count_until import CountUntil_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from robot_interfaces.action._count_until import CountUntil_FeedbackMessage as FeedbackMessage
